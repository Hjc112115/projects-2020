					...
					<tbody>
						<#list items as t>
							<tr id="item-${t.id}">
                                ...
                                <td>
                                    <button type="button" onclick="delItem(${t.id})" class="layui-btn layui-btn-primary layui-btn-sm">删除</button>
                                </td>
                            </tr>
						</#list>
						<tr>
						  ...
						  <td>
						    <button type="button" onclick="location.href='/order/add_order'" class="layui-btn layui-btn-primary layui-btn-sm">结算</button>
						  </td>
						</tr>
					</tbody>
				</table>
